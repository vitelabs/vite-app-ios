...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Vite-keystore/Vite_keystore.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/libEd25519Blake2b/libEd25519Blake2b.framework"
