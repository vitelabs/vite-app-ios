...
targetArray.each do |t|
    target t do
        ...
        vite_business_commit = 'b696ebb60ee9636577f22a8b2c1124fc4e1da4cf'
        ...
        vite_pod 'ViteUtils', :git => 'https://github.com/vitelabs/vite-utils-ios.git', :commit => '49acbc9e6cc7079f51ce43e3687eae0250a1a272'
