...
targetArray.each do |t|
    target t do
        ...
        vite_community_commit = '1f97f7ffaa1c44d3aaa1362ec51765c8142bf293'

        vite_business_git = 'https://github.com/vitelabs/vite-business-ios.git'
        vite_business_commit = '8931eef12202cfbbf5fb9285c08412e2436f3828'
        ...
        vite_pod 'ViteUtils', :git => 'https://github.com/vitelabs/vite-utils-ios.git', :commit => '68a52234be6050f758c6373f35bb8d4bd2ac0d68'
